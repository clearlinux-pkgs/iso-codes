...
Version  : 4.12.0
Release  : 30
URL      : https://salsa.debian.org/iso-codes-team/iso-codes/-/archive/v4.12.0/iso-codes-v4.12.0.tar.gz
Source0  : https://salsa.debian.org/iso-codes-team/iso-codes/-/archive/v4.12.0/iso-codes-v4.12.0.tar.gz
...
%prep
%setup -q -n iso-codes-v4.12.0
cd %{_builddir}/iso-codes-v4.12.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667834795
