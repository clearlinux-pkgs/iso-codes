...
Source0  : https://salsa.debian.org/iso-codes-team/iso-codes/-/archive/v4.11.0/iso-codes-v4.11.0.tar.gz
...
%prep
%setup -q -n iso-codes-v4.11.0
cd %{_builddir}/iso-codes-v4.11.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1658797490
