...
Version  : 4.15.0
Release  : 32
URL      : https://salsa.debian.org/iso-codes-team/iso-codes/-/archive/v4.15.0/iso-codes-v4.15.0.tar.gz
Source0  : https://salsa.debian.org/iso-codes-team/iso-codes/-/archive/v4.15.0/iso-codes-v4.15.0.tar.gz
...
%prep
%setup -q -n iso-codes-v4.15.0
cd %{_builddir}/iso-codes-v4.15.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1682961923
