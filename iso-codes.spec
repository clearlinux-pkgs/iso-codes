...
Version  : 4.4
Release  : 19
URL      : https://salsa.debian.org/iso-codes-team/iso-codes/-/archive/iso-codes-4.4/iso-codes-iso-codes-4.4.tar.gz
Source0  : https://salsa.debian.org/iso-codes-team/iso-codes/-/archive/iso-codes-4.4/iso-codes-iso-codes-4.4.tar.gz
...
%prep
%setup -q -n iso-codes-iso-codes-4.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1570111368
