...
Version  : 3.70
Release  : 1
URL      : http://pkg-isocodes.alioth.debian.org/downloads/iso-codes-3.70.tar.xz
Source0  : http://pkg-isocodes.alioth.debian.org/downloads/iso-codes-3.70.tar.xz
