...
Source0  : https://salsa.debian.org/iso-codes-team/iso-codes/-/archive/iso-codes-4.5.0/iso-codes-iso-codes-4.5.0.tar.gz
...
%prep
%setup -q -n iso-codes-iso-codes-4.5.0
cd %{_builddir}/iso-codes-iso-codes-4.5.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1589985801
...
cp %{_builddir}/iso-codes-iso-codes-4.5.0/COPYING %{buildroot}/usr/share/package-licenses/iso-codes/01a6b4bf79aca9b556822601186afab86e8c4fbf
%make_install
