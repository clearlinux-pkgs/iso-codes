...
Version  : 4.8.0
Release  : 26
URL      : https://salsa.debian.org/iso-codes-team/iso-codes/-/archive/v4.8.0/iso-codes-v4.8.0.tar.gz
Source0  : https://salsa.debian.org/iso-codes-team/iso-codes/-/archive/v4.8.0/iso-codes-v4.8.0.tar.gz
...
%prep
%setup -q -n iso-codes-v4.8.0
cd %{_builddir}/iso-codes-v4.8.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1636040041
...
cp %{_builddir}/iso-codes-v4.8.0/COPYING %{buildroot}/usr/share/package-licenses/iso-codes/01a6b4bf79aca9b556822601186afab86e8c4fbf
%make_install
