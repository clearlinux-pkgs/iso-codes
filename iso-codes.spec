...
Version  : 4.10.0
Release  : 28
URL      : https://salsa.debian.org/iso-codes-team/iso-codes/-/archive/v4.10.0/iso-codes-v4.10.0.tar.gz
Source0  : https://salsa.debian.org/iso-codes-team/iso-codes/-/archive/v4.10.0/iso-codes-v4.10.0.tar.gz
...
%prep
%setup -q -n iso-codes-v4.10.0
cd %{_builddir}/iso-codes-v4.10.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1654094214
...
cp %{_builddir}/iso-codes-v4.10.0/COPYING %{buildroot}/usr/share/package-licenses/iso-codes/01a6b4bf79aca9b556822601186afab86e8c4fbf
%make_install
